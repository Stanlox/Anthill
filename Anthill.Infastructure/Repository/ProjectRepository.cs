...
namespace Anthill.Infastructure.Repository
{
    public class ProjectRepository : IProjectRepository
    {
        ...
        public ProjectRepository(ApplicationDbContext dbContent)
        {
        ...
        public IQueryable<Project> getNewProjects
        {
            get
            {
                return dbContent.Projects.Where(x => x.EndDate > x.EndDate.AddYears(-1) && x.IsCompleted == false).Include(x => x.Category);
            }
        }
